...
<div id="loading" style="display: none; ">
    <div id="loading_bar">
        ...
        <p style="font-size: x-large; font-weight: bold;">해당 요청을 처리 중입니다 ...</p>
    </div>
</div>
<div class="wrapper">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-circle"
                                 src="${path}/dist/img/profile/${sessionUser.user_image}" alt="User profile picture">
...
<div class="modal fade" id="userOutModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left" data-dismiss="modal">닫기</button>
                <button type="button" class="btn btn-primary myInfoModModalBtn" id="deleteUser" disabled="disabled">탈퇴</button>
            </div>
        </div>
    </div>
</div>